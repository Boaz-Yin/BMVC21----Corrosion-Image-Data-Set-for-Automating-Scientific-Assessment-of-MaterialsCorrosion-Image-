...
config.augmentation.random_resize_crop.prob = 0.5
...
config.augmentation.random_perspective.prob = 0.5

config.augmentation.random_rotation = ConfigNode()
config.augmentation.random_rotation.degree_1 = -25
config.augmentation.random_rotation.degree_2 = 25
...
config.augmentation.random_rotation.prob = 0.5
...
config.augmentation.random_erasing.area_ratio_range_1 = 0.02
config.augmentation.random_erasing.area_ratio_range_2 = 0.4
