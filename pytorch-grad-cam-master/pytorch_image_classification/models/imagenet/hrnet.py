...
class HighResolutionNet(nn.Module):
    ...
    def __init__(self, config):
        ...
        self.stage1_config = config['MODEL']['EXTRA']['STAGE1']
        ...
        self.stage2_config = config['MODEL']['EXTRA']['STAGE2']
        ...
        self.stage3_config = config['MODEL']['EXTRA']['STAGE3']
        ...
        self.stage4_config = config['MODEL']['EXTRA']['STAGE4']
        ...
        self.stage4, pre_stage_channels = self._make_stage(
            self.stage4_config, num_channels, multi_scale_output=True)
