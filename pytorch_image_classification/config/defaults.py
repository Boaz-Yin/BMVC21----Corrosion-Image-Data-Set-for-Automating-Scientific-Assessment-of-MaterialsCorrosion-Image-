...
config.augmentation.random_crop.prob = 0.50
...
config.augmentation.gaussianblur.prob = 0.75
...
config.augmentation.colorjitter.hue = 0.5
config.augmentation.colorjitter.prob = 0.25
...
config.augmentation.random_rotation.degree_1 = -25.0
config.augmentation.random_rotation.degree_2 = 25.0
...
config.augmentation.random_rotation.prob = 0.75
...
config.augmentation.random_vertical_flip.prob = 0.50
...
config.augmentation.random_erasing.prob = 0.25
...
config.augmentation.random_erasing.max_attempt = 5
