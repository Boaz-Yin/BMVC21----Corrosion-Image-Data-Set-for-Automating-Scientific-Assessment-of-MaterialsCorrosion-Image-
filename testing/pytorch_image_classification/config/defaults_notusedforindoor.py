...
config.train.base_lr = 1e-3 #0.1
config.train.momentum = 0.9
config.train.nesterov = True
config.train.weight_decay = 5e-2 #1e-4
...
config.augmentation.use_randomresizecrop = False
config.augmentation.use_random_crop = False
config.augmentation.use_center_crop = False
config.augmentation.use_random_horizontal_flip = False
config.augmentation.use_gaussianblur = False
...
config.augmentation.use_random_vertical_flip = False
config.augmentation.use_random_perspective = False
config.augmentation.use_random_rotation = False

config.augmentation.random_resize_crop = ConfigNode()
config.augmentation.random_resize_crop.scale_1 = 0.3
config.augmentation.random_resize_crop.scale_2 = 0.7
config.augmentation.random_resize_crop.scale = (config.augmentation.random_resize_crop.scale_1,config.augmentation.random_resize_crop.scale_2)
config.augmentation.random_resize_crop.ratio_1 = 1.0
config.augmentation.random_resize_crop.ratio_2 = 1.0
config.augmentation.random_resize_crop.aspect_ratio = (config.augmentation.random_resize_crop.ratio_1,config.augmentation.random_resize_crop.ratio_2)
config.augmentation.random_resize_crop.prob = 0.25

config.augmentation.random_crop = ConfigNode()
config.augmentation.random_crop.padding = 2
config.augmentation.random_crop.fill = 0
config.augmentation.random_crop.padding_mode = 'edge'
config.augmentation.random_crop.prob = 0.75

config.augmentation.gaussianblur = ConfigNode()
config.augmentation.gaussianblur.kernel_size = 11
config.augmentation.gaussianblur.sigma = 10
config.augmentation.gaussianblur.prob = 0.5

config.augmentation.colorjitter = ConfigNode()
config.augmentation.colorjitter.bright_1 = 1.5
config.augmentation.colorjitter.bright_2 = 2.0
config.augmentation.colorjitter.brightness = (config.augmentation.colorjitter.bright_1,config.augmentation.colorjitter.bright_2)
config.augmentation.colorjitter.contrast_1 = 0.5
config.augmentation.colorjitter.contrast_2 = 1.5
config.augmentation.colorjitter.contrast = (config.augmentation.colorjitter.contrast_1,config.augmentation.colorjitter.contrast_2)
config.augmentation.colorjitter.sat_1 = 0.5
config.augmentation.colorjitter.sat_2 = 1.5
config.augmentation.colorjitter.saturation = (config.augmentation.colorjitter.sat_1,config.augmentation.colorjitter.sat_2)
config.augmentation.colorjitter.hue = 0.25
config.augmentation.colorjitter.prob = 0.75

config.augmentation.random_perspective = ConfigNode()
config.augmentation.random_perspective.distortion_scale = 0.25
config.augmentation.random_perspective.prob = 0.75

config.augmentation.random_rotation = ConfigNode()
config.augmentation.random_rotation.degree_1 = -75.0
config.augmentation.random_rotation.degree_2 = 75.0
config.augmentation.random_rotation.degrees = (config.augmentation.random_rotation.degree_1,config.augmentation.random_rotation.degree_2)
config.augmentation.random_rotation.expand = True
config.augmentation.random_rotation.prob = 0.50

config.augmentation.random_horizontal_flip = ConfigNode()
config.augmentation.random_horizontal_flip.prob = 0.25

config.augmentation.random_vertical_flip = ConfigNode()
config.augmentation.random_vertical_flip.prob = 0.75
...
config.augmentation.random_erasing.area_ratio_range_1 = 0.0
config.augmentation.random_erasing.area_ratio_range_2 = 0.05
config.augmentation.random_erasing.area_ratio_range = [config.augmentation.random_erasing.area_ratio_range_1, config.augmentation.random_erasing.area_ratio_range_2]
...
config.tta.resize = (256,256)

# test config
config.test = ConfigNode()
config.test.checkpoint = 'checkpoint_02000.pth'
config.test.output_dir = './pytorch_image_classification-master/out'
