...
config.augmentation.colorjitter.bright_1 = 0.5
config.augmentation.colorjitter.bright_2 = 1.5
...
config.augmentation.colorjitter.sat_1 = 1.5
config.augmentation.colorjitter.sat_2 = 2.0
...
config.augmentation.colorjitter.prob = 0.5
...
config.augmentation.random_horizontal_flip.prob = 0.75
...
config.augmentation.random_erasing.prob = 0.75
...
config.augmentation.random_erasing.max_attempt = 1
